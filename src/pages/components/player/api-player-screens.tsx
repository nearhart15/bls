...
const ApiSourceNotice:FC=()=> <Alert variant="info" className="py-2"><strong>API Data:</strong> game and series stats are calculated wherever the published league sheet supports them. “Known” achievement counts are minimums because the current sheet exposes season highs and the latest games. Career and rolling time frames rebuild totals, highs and achievement counts from archived LeagueSecretary recap data, including the weekly scratch scores and reported handicap. Frame-only categories such as strikes, spares, opens and shot detail remain unavailable.</Alert>;
