...
function historicalMetricValue(summary:ApiPlayerTimeframeSummary,metric:DetailMetric):number|null{switch(metric.label){case"Average":return summary.average;case"Games":return summary.games;case"Series Bowled":return summary.seriesCount;case"Pinfall":return summary.pinfall;case"Avg Series":return summary.averageSeries;case"High Game":return summary.highGame;case"High Series":return summary.highSeries;case"Known 600+ Series":return summary.known600Series;case"Known 700+ Series":return summary.known700Series;default:return null;}}
